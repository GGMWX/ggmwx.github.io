...
if (window.console && window.console.log) {
    console.log("%c Pio %c https://ggmwx.vercel.app/other/sponsor.html ","color: #fff; margin: 1em 0; padding: 5px 0; background: #673ab7;","margin: 1em 0; padding: 5px 0; background: #efefef;");
}
